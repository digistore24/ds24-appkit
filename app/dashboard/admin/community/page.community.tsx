...
// The route DECLARATION for `/dashboard/admin/community`. The page itself is in the module.
//
...
export { default } from "@/modules/community/admin/page";
export { generateMetadata } from "@/modules/community/admin/page";

...
// The route DECLARATION for `/dashboard/admin/course/submissions/[submissionId]`.
// The page itself is in the module.
//
...
//
// ⚠️ DYNAMIC route — `node run.mjs smoke` skips it. What covers it instead is
// written at the top of the page this points at.
//
// It delegates and holds no logic; `modules/boundary.test.ts` §1b enforces that.
export { default } from "@/modules/courses/pages/submissions/[submissionId]/page";
export { generateMetadata } from "@/modules/courses/pages/submissions/[submissionId]/page";

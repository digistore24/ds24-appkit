...
// The route DECLARATION for `/dashboard/admin/course`. The page itself is in the module.
//
...
export { default } from "@/modules/courses/admin/page";
export { generateMetadata } from "@/modules/courses/admin/page";

...
// The route DECLARATION for `/dashboard/community/people`. The page itself is in the module.
//
...
export { default } from "@/modules/community/pages/people/page";
export { generateMetadata } from "@/modules/community/pages/people/page";

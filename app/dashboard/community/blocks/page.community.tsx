...
// The route DECLARATION for `/dashboard/community/blocks`. The page itself is in the module.
//
...
export { default } from "@/modules/community/pages/blocks/page";
export { generateMetadata } from "@/modules/community/pages/blocks/page";

...
// The route DECLARATION for `/dashboard/community`. The page itself is in the module.
//
...
export { default } from "@/modules/community/pages/page";
export { generateMetadata } from "@/modules/community/pages/page";

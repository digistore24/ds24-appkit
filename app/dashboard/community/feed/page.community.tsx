...
// The route DECLARATION for `/dashboard/community/feed`. The page itself is in the module.
//
...
export { default } from "@/modules/community/pages/feed/page";
export { generateMetadata } from "@/modules/community/pages/feed/page";

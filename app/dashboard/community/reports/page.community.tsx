...
// The route DECLARATION for `/dashboard/community/reports`. The page itself is in the module.
//
...
export { default } from "@/modules/community/pages/reports/page";
export { generateMetadata } from "@/modules/community/pages/reports/page";

...
// The route DECLARATION for `/dashboard/community/reports/[reportId]`. The page itself is in the module.
//
...
export { default } from "@/modules/community/pages/reports/[reportId]/page";
export { generateMetadata } from "@/modules/community/pages/reports/[reportId]/page";

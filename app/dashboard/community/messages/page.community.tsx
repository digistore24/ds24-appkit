...
// The route DECLARATION for `/dashboard/community/messages`. The page itself is in the module.
//
...
export { default } from "@/modules/community/pages/messages/page";
export { generateMetadata } from "@/modules/community/pages/messages/page";

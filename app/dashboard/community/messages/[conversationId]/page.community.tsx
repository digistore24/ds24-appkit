...
// The route DECLARATION for `/dashboard/community/messages/[conversationId]`. The page itself is in the module.
//
...
export { default } from "@/modules/community/pages/messages/[conversationId]/page";
export { generateMetadata } from "@/modules/community/pages/messages/[conversationId]/page";

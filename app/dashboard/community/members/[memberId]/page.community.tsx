...
// The route DECLARATION for `/dashboard/community/members/[memberId]`. The page itself is in the module.
//
...
export { default } from "@/modules/community/pages/members/[memberId]/page";
export { generateMetadata } from "@/modules/community/pages/members/[memberId]/page";

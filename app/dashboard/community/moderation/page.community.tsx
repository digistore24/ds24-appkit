...
// The route DECLARATION for `/dashboard/community/moderation`. The page itself is in the module.
//
...
export { default } from "@/modules/community/pages/moderation/page";
export { generateMetadata } from "@/modules/community/pages/moderation/page";
